	...
	<body>
		<!---start-wrap---->
			...
			<div class="header" id="top">
				...
				<!---start-logo---->
				<div class="logo">
					<h1 align="center" ><font size="20px" color="white" >Change Basic Data</font></h1>
				</div>
				<!---End-logo---->	
				<!---start-top-nav---->
				<div class="top-nav">
			...
			<div class="contact">
				...
				<div class="col span_2_of_3">
				  <div class="contact-form">
				  	<h3>Please change your Basic Data!</h3>
					    <form method="post" action=".action">
					        <div>
						    	<span><label>E-Mail(Could Not Change!)</label></span>
