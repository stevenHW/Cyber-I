...
<div class="header" id="top">
				...
				<!---start-logo---->
				<div>
					<h1 align="center" ><font size="14px" color="white" >Image Search Result</font></h1>
			...
			<div class="border">
				...
				<div >
					...
					<form action="user.action" method="post">
						...
						<s:iterator id="a" value="#session.imageResults" status="L">
							<tr>
   					 			<td><s:property value="#a.title" /></td>
   					 			<td><a target="_blank" href="<s:property value="#a.url" />"><img src="<s:property value="#a.url" />" width="90" height="90"></a></td>
    								<td><input type="checkbox" name="i<s:property value="#L.index"/>" checked></td>
   							</tr>
					   	</s:iterator>	
						</table>
						<div align="center">
						<input type="submit" class="button small orange" value="submit"/>
						</div>
