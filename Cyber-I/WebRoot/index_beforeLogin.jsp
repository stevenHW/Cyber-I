  ...
  <body>
    <!---start-wrap---->
			...
			<div class="header" id="top">
				...
				<div class="top-nav">
					<ul>
						<li class="active"><a href="index_beforeLogin.jsp">Welcome</a></li>
						<li><a href="cyber-I_birth.jsp">Birth</a></li>
			...
			<div class="footer">
				<div class="wrap">
					<div class="footer-left">
						<a href="index_beforeLogin.jsp"><img src="" alt="" /></a>
					</div>
					<div class="footer-right">
						<a href="#top" class="scroll"> </a>
						<p><a target="_blank" href="index_beforeLogin.jsp">Huang Wei</a></p>
					</div>
					<div class="clear"> </div>
				</div>
			</div>
